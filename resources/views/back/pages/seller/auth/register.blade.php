...
@section('pageTitle', isset($pageTitle) ?: 'Seller Login')
    ...
    <div class="login-box bg-white box-shadow border-radius-10">
        ...
        <form action="{{ route('seller.register.post') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter Username" name="username" value="{{ old('username') ?? 'user-name' }}">
                @error('username')
