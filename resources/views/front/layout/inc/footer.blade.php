                    ...
                    <div class="footer-logo">
                        <div class="theme-logo">
                            <a href="{{route('home-page')}}">
                                <img src="{{ getSettingMedia('site_logo') }}" class="blur-up lazyload" alt>
                            </a>
                        </div>
                        ...
                        <div class="footer-logo-contain">
                            ...
                            <ul class="address">
                                <li>
                                    ...
                                    <a href="http://maps.google.com/maps?q={{urlencode( $settings['site_address'])}}" target="_blank">{{ $settings['site_address'] }}</a>
                                </li>
                                <li>
