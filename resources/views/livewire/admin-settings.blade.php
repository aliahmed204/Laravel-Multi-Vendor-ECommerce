            ...
            <div class="tab-pane fade {{ $tab == 'logo_favicon' ? 'active show' : '' }}" id="logo_favicon" role="tabpanel">
                <div class="pd-20">
                    <div class="row">
                        <div class="col-md-6">
                            <h5>Site logo</h5>
                            <div class="mb-2 mt-1" style="max-width: 350px;">
                                {{-- wire ignore changes here don't send request to server --}}
                                <img wire:ignore src="{{ $site_logo }}" class="img-thumbnail" data-ijabo-default-img="{{ $site_logo }}" id="site_logo_image_preview">
                            </div>
                        ...
                        <div class="col-md-6">
                            <h5>Site favicon</h5>
                            <div class="mb-2 mt-1" style="max-width: 350px;">
                                <img wire:ignore src="{{ $site_favicon }}" alt="" class="img-thumbnail" id="site_favicon_image_preview" data-ijabo-default-img="{{$site_favicon }}">
                            </div>
